...
public class PantallaEquipo2 extends JFrame {
    ...
    private void configurarEquipo(String nombreEquipo, String nombreJugador1, String nombreJugador2,
        ...
        juego.getEquipo2().setNombre(nombreEquipo.isBlank() ? "Equipo Rojo" : nombreEquipo);
        juego.getEquipo2().limpiarJugadores();
        ...
        if (cantidadJugadores == 2) {
            ...
            jugadorTrasero.setX(520);
            jugadorTrasero.setY(470);
            jugadores.add(jugadorTrasero);
            juego.getEquipo2().agregarJugador(jugadorTrasero);
        }

        controlador.enviarConfiguracionEquipo(juego.getEquipo2().getNombre(), jugadores);
        configurarControles();
        mostrarBotonListo();
        iniciarTimer();
    }
    ...
    private void configurarControles() {
        ...
        registrarAccionTeclado("W", 0, -18);
        registrarAccionTeclado("S", 0, 18);
        registrarAccionTeclado("A", -18, 0);
        registrarAccionTeclado("D", 18, 0);
        ...
        timerActualizacion.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                SwingUtilities.invokeLater(() -> {
                    ...
                    lblNombreEquipo.setText(juego.getEquipo2().getNombre());
    ...
    private void mostrarAyudaControles() {
        DialogosPartida.mostrarAyudaControles(this, "Usa W A S D para moverte y la barra espaciadora para golpear.");
    }
     ...
     *
     * <p>La línea divisoria de la cancha se dibuja en el borde izquierdo del panel ({@code x=40}),
     * representando la red desde esta perspectiva. Los márgenes de interpolación están
     * ajustados al lado derecho: X local va de 70 a {@code getWidth()-40}.</p>
     */
    private class PanelCancha extends JPanel {
        ...
        int localAMundoX(int xLocal) {
            return interpolar(xLocal, 70, getWidth() - 40, MUNDO_X_MIN, MUNDO_X_MAX);
        }
        ...
        int mundoALocalX(int xMundo) {
            return interpolar(xMundo, MUNDO_X_MIN, MUNDO_X_MAX, 70, getWidth() - 40);
        }
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2.fillRoundRect(40, 30, getWidth() - 60, getHeight() - 60, 24, 24);
            g2.setColor(Color.WHITE);
            g2.setStroke(new BasicStroke(3f));
            g2.drawRoundRect(40, 30, getWidth() - 60, getHeight() - 60, 24, 24);
            g2.drawLine(40, 30, 40, getHeight() - 30);

            List<Jugador> jugadores = new ArrayList<>(juego.getEquipo2().getJugadores());
            for (Jugador jugador : jugadores) {
